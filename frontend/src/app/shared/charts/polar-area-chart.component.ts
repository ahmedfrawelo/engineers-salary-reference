...
import { ChartDatum, PolarAreaDatum } from './chart-types';
...
@Component({
  selector: 'engineers-salary-reference-polar-area-chart',
  standalone: true,
  imports: [],
  template: `
...
export class EngineersSalaryPolarAreaChartComponent implements AfterViewInit, OnChanges, OnDestroy {
  @Input() data: PolarAreaDatum[] = [];
  @Input() height = 240;
  ...
  showTooltip(event: MouseEvent, slice: PolarSlice): void {
  ...
  onSliceClick(slice: PolarSlice): void {
